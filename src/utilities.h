...
public:
    ...
    static void writeCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, std::string name);
    static void writeCloud(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud, std::string name);
