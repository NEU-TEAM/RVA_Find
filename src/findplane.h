...
private:
    ...
    void processEachInliers(std::vector<pcl::PointIndices> indices_in, pcl::PointCloud<PointT>::Ptr cloud_in,  bool iswrite, bool isShow);
    void getCloudByConditions(pcl::PointCloud<PointT>::Ptr cloud_source, pcl::PointIndices::Ptr &inliers_plane, double thc, double thn);
